...
!$ACDC singlecolumn
!$ACDC singlecolumn --suffix-singlecolumn _OPENACC_BITREPRO --use-bit-repro-intrinsics
...
REAL(KIND=JPRB) :: ZA, ZALP1, ZALP2, ZALPHA, ZALTI, ZARGLI, ZAUSR,&
 ...
 & ZTEMPF(KLON), ZTUNE, ZUSTAR, ZVSTAR, ZX, ZZPR, ZRZR
...
!     LLTEST POUR EVITER DES CALCULS INUTILES.
!     LLTEST TO AVOID UNNECESSARY COMPUTATIONS.
