...
IF (KPRINTLEV >= 1) THEN
  ...
  WRITE(KULOUT,'(''RUNDEF2 = '',E14.7)') RUNDEF2
  WRITE(KULOUT,'('' *** Slant total delay  ***'')')
  WRITE(KULOUT,'(''        RK1  = '',E13.7)') RK1
  WRITE(KULOUT,'(''        RK2  = '',E13.7)') RK2
  WRITE(KULOUT,'(''        RK3  = '',E13.7)') RK3
  WRITE(KULOUT,'(''   RGNSSSAT  = '',E13.7)') RGNSSSAT
  WRITE(KULOUT,'(''   RGNSSEAR  = '',E13.7)') RGNSSEAR
  WRITE(KULOUT,'(''      RAWGS  = '',E13.7)') RAWGS
  WRITE(KULOUT,'(''      REWGS  = '',E13.7)') REWGS
  WRITE(KULOUT,'(''      RFWGS  = '',E13.7)') RFWGS
  WRITE(KULOUT,'(''      RGEQU  = '',E13.7)') RGEQU
  WRITE(KULOUT,'(''      RGRAT  = '',E13.7)') RGRAT
  WRITE(KULOUT,'(''      RKSSOM = '',E13.7)') RKSSOM
ENDIF
