...
!    REVASXR  : MAXIMUM EVAPORATION RATE FOR STRATIFORM PRECIPITATION FOR RAIN.
!    REVASXS  : MAXIMUM EVAPORATION RATE FOR STRATIFORM PRECIPITATION FOR SNOW.
!    REVASXG  : MAXIMUM EVAPORATION RATE FOR STRATIFORM PRECIPITATION FOR GRAUPEL.
!    RNINTR   : INTERCEPT PARAMETER FOR RAIN.
!    RNINTS   : INTERCEPT PARAMETER FOR ICE.
!    RNINTG   : INTERCEPT PARAMETER FOR GRAUPEL.
...
!    TFVLD    : DEPOSITION SPEED OF CLOUD LIQUID WATER.
...
!    ETKE_DTHETA_S1: threshold for Cu regime affecting mix. length near PBL top
!    ETKE_DTHETA_S2: threshold for Sc regime affecting mix. length near PBL top
!    ETKE_LBLT1: value of mix. length near PBL top for Cumulus regime
!    ETKE_LBLT2: value of mix. length near PBL top for Stratocumulus regime
!    ETKE_HUTLS: height above which upper-air turbulent lenght scale is applied
!    ETKE_LUTLS: the value of const. upper-air turb. lenght scale with EL1/2
...
!    ETKE_RIFGR: weight given to Rif inverted from Ri
!    TOUCANS - EFB scheme
!    EFB_AZ0
!    EFB_UR    : Unstable prolongation of R of EFB
!    REFB_1, REFB_2, REFB_3 : R  in Rif for stable startification
!    RPBLH_UP  : tuning parameter for PBL height calculated from L_up
...
!               IN ACPLUIE_PROG
! RCPCOEF1 : FIRST COEFFICIENT FOR CHABOUREAU & PINTY RQICR COMPUTATION
! RCPCOEF2 : SECOND COEFFICIENT FOR CHABOUREAU & PINTY RQICR COMPUTATION
! RCPCOEF3 : THIRD COEFFICIENT FOR CHABOUREAU & PINTY RQICR COMPUTATION
...
REAL(KIND=JPRB)   :: GCVFMAX ! Maximum convective heat flux.
REAL(KIND=JPRB)   :: GLIGHT ! tuning factor for the lightning parameterization.
